...
#define	arena_metadata_add JEMALLOC_N(arena_metadata_add)
#define	arena_metadata_get JEMALLOC_N(arena_metadata_get)
#define	arena_metadata_sub JEMALLOC_N(arena_metadata_sub)
...
#define	extent_purge_wrapper JEMALLOC_N(extent_purge_wrapper)
...
#define	prng_state_next JEMALLOC_N(prng_state_next)
...
#define	psz2ind_clamp JEMALLOC_N(psz2ind_clamp)
#define	psz2ind_impl JEMALLOC_N(psz2ind_impl)
...
#define	tcache_next_easy JEMALLOC_N(tcache_next_easy)
#define	tcache_alloc_large JEMALLOC_N(tcache_alloc_large)
#define	tcache_alloc_small JEMALLOC_N(tcache_alloc_small)
#define	tcache_next_small JEMALLOC_N(tcache_next_small)
#define	tcache_alloc_small_hard JEMALLOC_N(tcache_alloc_small_hard)
#define	tcache_next_small_hard JEMALLOC_N(tcache_next_small_hard)
